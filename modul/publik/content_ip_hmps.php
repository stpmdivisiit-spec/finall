<?php
$data = $koneksi->query("SELECT * FROM kema_hmps WHERE prodi='pemerintahan'")->fetch_assoc();
?>
<main>
    <div class="bg-primary text-white pt-5 pb-10">
            ...
            <div class="col-lg-7 mb-4">
                <div class="card shadow-sm border-0 h-100 rounded-4">
                    <div class="card-body p-5">
                        <span class="badge bg-primary bg-opacity-25 text-primary rounded-pill px-3 py-2 mb-3">Tentang Organisasi</span>
                        ...
                        <hr class="mb-4">
                        <h6 class="fw-bold text-primary mb-3"><i class="fas fa-bullseye me-2"></i> Fokus Program Kerja</h6>
            ...
            <div class="col-lg-5 mb-4">
                <div class="card shadow-sm border-0 h-100 rounded-4 text-center py-5 bg-light">
                    <div class="card-body d-flex flex-column justify-content-center align-items-center">
                        <i class="fas fa-sitemap fa-4x text-primary mb-4"></i>
                        ...
                        <?php if(!empty($data['file_struktur'])): ?>
                            <a href="uploads/kemahasiswaan/<?= $data['file_struktur'] ?>" target="_blank" class="btn btn-primary rounded-pill px-5 fw-bold shadow-sm">Lihat Bagan Struktur</a>
                        <?php else: ?>
