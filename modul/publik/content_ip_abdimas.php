...
$query = @mysqli_query($koneksi, "SELECT * FROM prodi_akreditasi WHERE prodi = 'pemerintahan' ORDER BY tahun_sk DESC LIMIT 1");
...
<main>
    <div class="bg-primary text-white pt-5 pb-10 text-center" style="min-height: 45vh;">
                            ...
                            <table class="table table-borderless text-start mx-auto border" style="max-width: 90%; border-radius: 10px; overflow: hidden;">
                                <tbody>
                                    ...
                                    <tr class="bg-light">
                                        ...
                                        <td class="text-primary fw-bold py-3 px-4">Sampai <?= $masa_berlaku ?></td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
