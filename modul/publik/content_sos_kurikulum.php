<?php
// 1. Ambil semua MK untuk Sosiatri
$query = $koneksi->query("SELECT * FROM prodi_kurikulum WHERE prodi = 'sosiatri' ORDER BY semester ASC, jenis_mk DESC, nama_mk ASC");
...
<main>
    <header class="page-header page-header-dark bg-success pb-10">
        <div class="container-xl px-4 pt-5">
            <h1 class="page-header-title text-white"><i data-feather="book-open" class="me-2"></i> Kurikulum Pembangunan Sosial</h1>
