...
$query_dosen = $koneksi->query("SELECT * FROM prodi_riset_abdimas WHERE prodi = 'sosiatri' AND kategori = 'penelitian_dosen' ORDER BY tahun DESC LIMIT 10");
$query_mhs   = $koneksi->query("SELECT * FROM prodi_riset_abdimas WHERE prodi = 'sosiatri' AND kategori = 'riset_mahasiswa' ORDER BY tahun DESC LIMIT 10");
$query_abdimas = $koneksi->query("SELECT * FROM prodi_riset_abdimas WHERE prodi = 'sosiatri' AND kategori = 'abdimas' ORDER BY tahun DESC LIMIT 10");
?>
<main>
