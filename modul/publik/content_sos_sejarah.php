<?php
// Ambil Naskah
$query = @mysqli_query($koneksi, "SELECT id, konten_sejarah FROM prodi_sejarah WHERE prodi = 'sosiatri' LIMIT 1");
...
<style>
    ...
    .timeline-container-success h4::before {
        content: "";
        position: absolute;
    ...
    .timeline-container-success p:last-child {
