<?php
$query = @mysqli_query($koneksi, "SELECT * FROM prodi_struktur_organisasi WHERE prodi = 'pemerintahan' LIMIT 1");
$data = mysqli_fetch_array($query);

$ketua_prodi = $data['ketua_prodi_nama'] ?? 'Nama Kaprodi, S.IP., M.Si.';
$sekretaris_prodi = $data['sekretaris_prodi_nama'] ?? 'Nama Sekprodi, S.IP., M.A.';
$kepala_lab = $data['kepala_lab_nama'] ?? 'Kepala Laboratorium Pemerintahan';
$tugas_lab = $data['kepala_lab_tugas'] ?? 'Mengelola pusat simulasi sidang & kebijakan publik.';
$staf_admin = $data['staf_admin_nama'] ?? 'Staf Administrasi Prodi';
$tugas_admin = $data['staf_admin_tugas'] ?? 'Layanan persuratan dan administrasi akademik prodi.';
?>
            ...
            <div class="page-header-content pt-4">
                <div class="row align-items-center justify-content-between">
                    <div class="col-auto mt-4">
                        ...
                        <div class="page-header-subtitle">Tata kelola dan manajemen akademik Prodi Ilmu Pemerintahan.</div>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="row justify-content-center mx-auto" style="width: 45%; margin-top: 25px;">
                    <div class="col-sm-6 mb-3 px-2">
                        <div class="bg-light rounded-3 p-4 h-100 shadow-none border-0">
                            <i class="fas fa-landmark fa-2x text-warning mb-3"></i>
